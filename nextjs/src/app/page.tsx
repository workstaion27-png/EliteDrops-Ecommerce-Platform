...
export default function HomePage() {
  ...
  return (
    <div className="pt-16">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-gray-900 via-luxury-dark-gray to-gray-900 text-white overflow-hidden">
        ...
        {/* Floating elements */}
        <div className="absolute top-20 right-20 w-32 h-32 bg-amber-500/10 rounded-full blur-xl animate-pulse"></div>
        <div className="absolute bottom-20 left-20 w-48 h-48 bg-amber-500/5 rounded-full blur-2xl animate-pulse delay-1000"></div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="max-w-2xl">
              <div className="inline-flex items-center px-4 py-2 bg-amber-500/20 border border-amber-500/30 rounded-full mb-6">
                <span className="text-amber-500 text-sm font-medium">✨ New Collection Just Arrived</span>
              </div>
              <h1 className="text-4
              
              xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                Luxury Redefined<br />
                <span className="text-amber-500">Crafted for You</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link 
                  href="/products"
                  className="inline-flex items-center justify-center px-8 py-4 bg-amber-500 text-gray-900 font-bold rounded-lg hover:bg-amber-400 transition-all duration-300 transform hover:scale-105 shadow-xl"
                >
                ...
                <Link 
                  href="/track-order"
                  className="inline-flex items-center justify-center px-8 py-4 border-2 border-amber-500 text-amber-500 font-semibold rounded-lg hover:bg-amber-500 hover:text-gray-900 transition-all duration-300"
                >
                  Track Your Order
                </Link>
              </div>
              ...
              {/* Trust indicators */}
              <div className="flex items-center gap-6 mt-8 pt-8 border-t border-amber-500/20">
            ...
            <div className="hidden lg:block">
              <div className="relative">
                <div className="w-full h-96 bg-gradient-to-br from-amber-500/20 to-amber-500/5 rounded-2xl border border-amber-500/30 backdrop-blur-sm flex items-center justify-center">
                  <div className="text-center">
                    <div className="w-24 h-24 bg-amber-500 rounded-full flex items-center justify-center mx-auto mb-4">
                      <span className="text-3xl">✨</span>
                    </div>
                    <p className="text-amber-500 font-medium">Premium Experience</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-amber-400">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center mb-8">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900">Curated Collections</h2>
              <p className="text-luxury-dark-gray mt-2">Handpicked premium products for the discerning customer</p>
            </div>
            <Link href="/categories" className="text-amber-500 font-medium hover:text-amber-600 transition-colors">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {categories.map((category) => (
              ...
              >
                ...
                {/* Badge */}
                {category.badge && (
                  <div className="absolute top-3 right-3 px-2 py-1 bg-amber-500 text-gray-900 text-xs font-bold rounded-full">
                    {category.badge}
                  </div>
                )}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center mb-8">
            ...
            <Link href="/products" className="text-amber-500 font-medium hover:text-amber-600 transition-colors">
              View All Products →
            </Link>
          </div>
          {loading ? (
      ...
      {/* CTA Section */}
      <section className="py-16 bg-gradient-to-r from-gray-900 to-luxury-dark-gray text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              href="/products"
              className="inline-flex items-center px-8 py-4 bg-amber-500 text-gray-900 font-bold rounded-lg hover:bg-amber-400 transition-all duration-300 transform hover:scale-105"
            >
              Start Shopping
              <ArrowRight className="ml-2 h-5 w-5" />
            </Link>
            <Link 
              href="/track-order"
              className="inline-flex items-center px-8 py-4 border-2 border-amber-500 text-amber-500 font-semibold rounded-lg hover:bg-amber-500 hover:text-gray-900 transition-all duration-300"
            >
              Track Your Order
            </Link>
          </div>
